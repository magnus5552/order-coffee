...
function input(props, onCheck, ...children) {
  ...
  elem.addEventListener("change", (e) => onCheck(e.target.value));
  return elem;
}
...
let form = drinkForm({ drinks });

body.appendChild(form);

document.querySelector('.add-button').addEventListener('click', _ => {
  drinks.push({...defaultDrink});
  form.remove();
  body.appendChild((drinkForm({drinks})));
});
